	...
	<view class="container">
		<view class="top">
			...
			<view class="top-right">
				<view class="search">
					<navigator url="../search/search"><image src="../../static/f3.png"></image></navigator>
				</view>
			</view>
		</view>
			...
			<view class="article" v-for="(article, index) in articles" :key="index" v-show="recommend">
				...
				<view class="" v-if="article.imgs.length >= 3">
					<view class="thumbnail-box">
						<view class="thumbnail-item" v-for="(item, index2) in article.imgs" :key="index2">
				...
				<view class="" v-else-if="article.imgs.length >= 1">
					<view class="text-img-box">
						<view class="left">
							<text>{{handleContent(article.content)}} 
...
——《人间失格》 ​ </text>
		...
		<view class="btn">
			<navigator url="../write/write" hover-class="navigator-hover">
				<view class="btn-up"><image src="../../static/plus-circle.png"></image></view>
			</navigator>
		</view>
	</view>
</template>
