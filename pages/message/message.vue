	...
	<view class="container">
		<view class="top">
			<view class="avatar-box">
				<image src="../../static/xiaoxi.png" mode="scaleToFill" class="avatar" v-if="!storageData.login"></image>
				<image src="../../static/money.png" mode="scaleToFill" class="avatar" v-if="!storageData.login"></image>
			</view>
					...
					<view class="grace-news-list" style="padding:25upx; width:700upx;">
						<navigator v-for="(item, index) in news" :key="index">
							<view class="grace-news-list-items">
								<image src="../../static/imgs/logo.png" class="grace-news-list-img grace-list-imgs-l" mode="widthFix"></image>
								<view class="grace-news-list-title">
									<view class="grace-news-list-title-main">简信 [ {{ index }} ]</view>
									<text class="grace-news-list-title-desc grace-text-overflow">新简信</text>
								</view>
							</view>
						</navigator>
					</view>
	...
	data() {
		return {
			...
			tabs: [
				...
				{ name: '互动消息', id: 'hudongxiaoxi', loadingType: 0, page: 1 },
				{ name: '简阅币', id: 'jianyuebi', loadingType: 0, page: 1 },
				{ name: '其他提醒', id: 'qitatixing', loadingType: 0, page: 1 }
			],
			newsAll: newsAll
		};
	},
