	...
	<view class="container">
		<view class="list">
			<view class="list-item list-item-heigher">
				...
				<view class="right">{{ nickname }}</view></navigator>
			</view>
			<view class="list-item list-item-heigher">
			...
			<view class="list-item list-item-heigher"><view class="left">消息通知</view></view>
			<view class="list-item list-item-heigher"><view class="left">通用</view></view>
		</view>
	</view>
</template>
